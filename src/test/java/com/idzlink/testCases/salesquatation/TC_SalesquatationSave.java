...
public class TC_SalesquatationSave extends BaseClass {

	@Test
	public void savesalesquatation() throws InterruptedException, IOException
	{
		intilization(); //login
		...
		{
			captureScreen(driver,"savesalesquatation");
