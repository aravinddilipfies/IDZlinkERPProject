...
public class TC_salesquatationConfirmSave extends BaseClass {

	@Test
	public void salesquatationConfirmSave() throws InterruptedException, IOException
	{
		intilization(); //login
		...
		{
			captureScreen(driver,"salesquatationConfirmSave");
