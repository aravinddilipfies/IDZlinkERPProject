...
public class TC_MRPitemaddingpos extends BaseClass  {
@Test
public void MRPitemaddingpos() throws InterruptedException, IOException {
	intilization();
	...
	if (succ.toLowerCase().contains("saved successfully".toLowerCase())) {
		...
		captureScreen(driver,"MRPitemaddingpos");
