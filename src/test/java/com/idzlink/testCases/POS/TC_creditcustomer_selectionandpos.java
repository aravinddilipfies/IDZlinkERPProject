...
public class TC_creditcustomer_selectionandpos extends BaseClass  {
@Test
public void creditcustomer_selectionandpos() throws InterruptedException, IOException {
	intilization();
	...
	if (succ.toLowerCase().contains("saved successfully".toLowerCase())) {
		...
		captureScreen(driver,"creditcustomer_selectionandpos");
