...
public class TC_pointofsaleitemnameserach extends BaseClass {
@Test
public void pointofsaleitemnameserach() throws InterruptedException, IOException {
	intilization();
	...
	if (succ.toLowerCase().contains("saved successfully".toLowerCase())) {
		...
		captureScreen(driver,"pointofsaleitemnameserach");
